...
Version: 1.3-broker
Author: Elvtn, LLC - modified by 1ixLLC
...
class elvtn_Zillow_Reviews extends WP_Widget {
	...
	public function form( $instance ) {
        ...
        <input type="checkbox" id="<?php echo $this->get_field_id( 'members' ); ?>" name="<?php echo $this->get_field_name( 'members' ); ?>" value="true" <?php if($members === "true" ) echo "checked" ?>" />
